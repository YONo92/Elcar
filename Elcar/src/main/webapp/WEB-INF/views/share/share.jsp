  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body onload="initTmap();">
      ...
      <section style="width: 100%; height: 1000px">
        ...
        <div>
          <input type="text" class="text_custom" id="searchKeyword1" name="searchKeyword1" placeholder="출발지 검색" />
        ...
        <div>
          <input type="text" class="text_custom" id="searchKeyword2" name="searchKeyword2" placeholder="도착지 검색"
            value="" />
