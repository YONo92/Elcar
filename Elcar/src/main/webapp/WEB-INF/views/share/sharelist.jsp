		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12" id="disp">
					<button class="btn btn-danger rounded-pill d-inline" style="margin-bottom: 10px"
						type="button" onclick="location.href='share'">탈래 신청</button>
					<c:forEach var="share" items="${shareList}">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="blog__item ">
									<div class="blog__item__pic set-bg" id="map_div"
										data-setbg="resources/img/breadcrumb-bg.jpg">
										<div id="map_div"></div>
									...
									<div class="blog__item__text ">
										...
										<span class="badge badge-danger rounded-pill d-inline">${share.status == 0? '매칭전' : '매칭'}</span>
			...
			<a href="#" class="btn_gotop"
				...
				class="btn btn-danger  glyphicon glyphicon-chevron-up"> TOP
			</span>
			</a>
		</div>
							...
							html += "<div class='row'>"
								html += "<div class='col-lg-12 col-md-12 col-sm-12'>"
									html += "<div class='blog__item'>"
										...
										html += '<span class="badge badge-danger rounded-pill d-inline">'
