        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="services__item">
              ...
              <h5>ELCAR Service</h5>
              <p>
                ELCAR만의 이용자 편의 중심 전기차 충전소 검색 서비스와
                카쉐어링을 추천합니다.
              </p>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="services__item">
              ...
              <h5>전기차 충전소 찾기</h5>
              <p>
                지역별, 사용자 위치별 <br />가장 가까운 전기차 충전소를
                <br />검색해보세요.
              </p>
              <a href="https://map.kakao.com/link/search/전기차충전소"
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="services__item">
              ...
              <h5>카쉐어링</h5>
              <p>
                드라이버와 함께 목적지까지 전기차 쉐어링 어떠세요? <br />
                <br />
              </p>
              <form id="locationForm" action="../sharelist" method="post">
                <input type="hidden" id="lat" name="lat" />
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="services__item">
              ...
              <h5>매너등급제</h5>
              <p>
                카쉐어링을 통한 ELCAR만의 포인트를 적립해보세요. <br />
                <br />
              </p>
