...
<!-- Blog Details Hero Begin -->
    <section class="blog-details-hero spad set-bg" data-setbg="resources/img/blog/details/details-hero-bg.jpg">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-10">
                    <div class="blog__details__hero__text">
                        ...
                        <ul>
                            <li><img src="resources/img/blog/details/details-hero-avatar.png" alt=""> <span>By Evelyn Lane</span>
                            </li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="blog__details__author">
                        <div class="blog__details__author__pic">
                            <img src="resources/img/blog/details/author.png" alt="">
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <a href="#" class="blog__details__btns__item set-bg"
                                            data-setbg="resources/img/blog/details/pre.jpg">
                                    ...
                                    <div class="col-lg-6">
                                        <a href="#" class="blog__details__btns__item set-bg"
                                            data-setbg="resources/img/blog/details/next.jpg">
                                            <h6>Promotional Advertising Specialty</h6>
                                            <ul>
                                                <li>By Don Townsend</li>
                                                <li>Dec 22, 2018</li>
