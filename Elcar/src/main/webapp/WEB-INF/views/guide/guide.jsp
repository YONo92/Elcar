				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="about__feature__item">
							...
							<h5>검증된 드라이버</h5>
							<p>엘카는 면허취득후 1년이 지난 분들만 드라이버로 등록되며 실제 자차소유자만 드라이버로 등록될수 있어
								신원이 확인된 사람들의 차를 이용하수 있습니다.</p>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="about__feature__item">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="about__item">
						...
						<p>자동차 산업에서의 파괴적인 혁신이 가속화되고 있다. 자동차산업의 기술패러다임이 내연기관에서 전기동력으로
							바뀌고 있는 가운다 자동차의 스마트화가 더 빠른 속도로 진행되고 있다.</p>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="about__item">
						<h5>엘카 서비스 개요</h5>
						<p>매연을 뿜어내지 않는 전기차는 대기오염에 시달리는 현대인들에게는 큰 매력으로 다가온다. 건강에 좋다는 점과
							더불어 전기차를 운전하는 또 하나의 매력은 심리적인 것이다. 인간에게 오염되어 병들어 가는 지구를 위해서 친환경적인
							전기차를 운전함으로써 인류와 자연에 공헌한다는 믿음이 전기차를 운전하는 사람들에게 일종의 자부심과 심리적 평안을
							가져다 주기도 한다.</p>
					</div>
				</div>
			</div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="section-title about-title">
              <h2>Wellcome To ELCAR</h2>
              <p>
                엘카는 전기차 충전소 찾기 서비스와 전기차카쉐어링을 제공하는
                서비스입니다.<br />
              </p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="about__feature__item">
                ...
                <h5>검증된 드라이버</h5>
                <p>
                  엘카는 면허취득후 1년이 지난 분들만 드라이버로 등록되며 실제
                  자차소유자만 드라이버로 등록될수 있어 신원이 확인된 사람들의
                  차를 이용하수 있습니다.
                </p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="about__feature__item">
                ...
                <h5>신고게시판</h5>
                <p>
                  카쉐어링을 이용하다 불편한점 이나 탑승자분 운전자분의 불쾌한
                  언행을 신고 할수 있습니다.
                </p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="about__feature__item">
                ...
                <h5>전기차 충전소</h5>
                <p>
                  위치를 기반으로 한 전기차 충전소를 조회 할 수 있으며 길찾기
                  또한 가능합니다.
                </p>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="about__item">
              <h5>내연기관 자동차에서 전기동력 자율주행차시대로 전환</h5>
              <p>
                자동차 산업에서의 파괴적인 혁신이 가속화되고 있다. 자동차산업의
                기술패러다임이 내연기관에서 전기동력으로 바뀌고 있는 가운다
                자동차의 스마트화가 더 빠른 속도로 진행되고 있다.
              </p>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="about__item">
              <h5>엘카 서비스 개요</h5>
              <p>
                매연을 뿜어내지 않는 전기차는 대기오염에 시달리는 현대인들에게는
                큰 매력으로 다가온다. 건강에 좋다는 점과 더불어 전기차를
                운전하는 또 하나의 매력은 심리적인 것이다. 인간에게 오염되어
                병들어 가는 지구를 위해서 친환경적인 전기차를 운전함으로써
                인류와 자연에 공헌한다는 믿음이 전기차를 운전하는 사람들에게
                일종의 자부심과 심리적 평안을 가져다 주기도 한다.
              </p>
            </div>
          </div>
        </div>
