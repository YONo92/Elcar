				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__links">
							<a href="../"><i class="fa fa-home"></i> Home</a> <span>회원 정보</span>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="services spad">
		...
		<div class="car__details__sidebar" >
			<div class="car__details__sidebar__model" align=left>
				<ul>
					<li ><h3><b>탈퇴 안내</b></h3> <span></span></li>
					<br>
					<br>
					<br>
				</ul>
				<ul>
					...
					<li><h6>
							...
							<h6>
								<span></span></li>
					<span style="color: orange;"><b>탈퇴한 아이디는 본인과 타인 모두 재사용 및 복구가 불가하오니</b> </span>
					<span style="color: black;" >신중하게 선택하시기 바랍니다.</span>
					<div style="height:150px;"></div>
				</ul>

				<ul>
					<li><h6><b>탈퇴 후 회원정보 및 개인형 서비스 이용기록은 모두 삭제됩니다.</b></h6></li>
					<li>회원정보 및 드라이버 정보 등 개인형 서비스 이용기록은 모두 삭제되며, 삭제된 데이터는 복구되지 않습니다.</li>
				
				
				<div style="height:300px;">
					<table border="2" bordercolor="gray" width="500" height="200" align="left">
