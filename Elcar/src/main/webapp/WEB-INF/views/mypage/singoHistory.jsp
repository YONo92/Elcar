			...
			<div class="section-title">
				...
				<div align="left">
					...
					<div class="testimonial__item__author">
						<div class="row">
							<div class='col-lg-2'>
								<input type="text" id="id" value="$[date ]" style="width:100px; height:40px; "disabled>
		
							</div>
							
							<div class='col-lg-3'>
								<h5 style="font-size: 1.4em; color: black" class="nanum"><b> 닉네임 : </b>
									<span> <b style="font-size: 1.2em; color: green;">$[name]</b></span> 
								</h5>
							</div>
							
							<div class='col-lg-4'>
								<h5 style="font-size: 1.4em; color: black" class="nanum"><b> 신고유형 : </b>
									<span> <b style="font-size: 1.2em; color: green;">$[category]</b></span>
								</h5>
							</div>
							...
							<div class='col-lg-3'>
								<input type="text" value="답변 대기중" class="btn btn-outline-success" style="font-size: 1.0em; color: black;">
							</div>
						</div>
					</div>	
					<hr style=" height:100px;">
					...
					<div class="testimonial__item__author">
						<div class="row">
							...
							<div class='col-lg-3'>
								<input type="text" value="답변 완료" class="btn btn-outline-success" style="font-size: 1.0em; color: black;">
							</div>
						</div>
					</div>	
					<hr style=" height:100px;">
