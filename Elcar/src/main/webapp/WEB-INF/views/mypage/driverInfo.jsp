									...
									<div class="p-5">
										...
										<div class="row mb-4">
											<div class="input-group col-12">
												<label class="input-group-text mr-2"
													for="inputGroupSelect01">차종</label> <input type="text"
										...
										<div class="row mb-4">
											<div class="input-group col-12">
												<label class="input-group-text mr-2"
													for="exampleInputCarnum">차 번호</label> <input type="text"
													class="form-control form-control-user"
