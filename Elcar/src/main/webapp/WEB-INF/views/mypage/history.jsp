...
<body>
	...
	<section class="services spad">
		<div class="container" align="right">
						...
						<div class="testimonial__item__author">
							<c:forEach var="history" items="${historyDrivingList }">
								<div class="row">
									...
									<div class='col-lg-1 '>${history.date}</div>
									<div class='col-lg-2'>
										<h5 style="font-size: 1.4em; color: green" class="nanum">
											${history.taker_id  }<span> <b
												style="font-size: 1.2em; color: black;">님이</b></span>
										</h5>
									</div>
									...
									<div class='col-lg-2'>
										<h5 style="font-size: 1.4em; color: green" class="nanum">
											${history.giver_id }<span> <b
												style="font-size: 1.2em; color: black;">님을</b></span>
										</h5>
									</div>

									<div class='col-lg-3'>
										<span style="font-size: 1.2em; color: black;"> <b>
												&emsp; 태우셨습니다.</b>
										</span>
									</div>
									...
									<div class='col-lg-3'>
										...
										<botton type="submit" class="btn btn-outline-success"
											style="font-size: 1.0em; color: black;"> <i
											class="fas fa-car"> 출발지</i> </botton>

										<botton type="submit" class="btn btn-outline-success"
											style="font-size: 1.0em; color: black;"> <i
											class="fas fa-car"> 도착지</i> </botton>
										<br>
										<br>
										<br>
										<br>
					...
					<c:forEach var="history" items="${historyDDubukList }">
						<div class="row">
							...
							<div class='col-lg-2'>
								<h5 style="font-size: 1.4em; color: green" class="nanum">
									${history.giver_id }<span> <b
										style="font-size: 1.2em; color: black;">님에게</b></span>
								</h5>
							</div>
			...
			<!-- 페이지 이동 버튼 -->
			<div class="pagination__option" style="height: 150px;" align=center>
				<a href="#"><span class="arrow_carrot-2left"></span></a> <a href="#">1</a>
				<a href="#">2</a> <a href="#">3</a> <a href="#"><span
					class="arrow_carrot-2right"></span></a>
			</div>
		</div>
		</div>
	...
	<span id="alerts" style="margin: 5px;"> <span id="alert"
		class="alert"
		style="border: none; background-color: #d3d3d3; cursor: pointer; width: 55px; padding: 0px">신고</span>
