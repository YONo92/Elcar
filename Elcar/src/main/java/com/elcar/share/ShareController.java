...
//	public ModelAndView sinchengModi(@PathVariable("num") int num, Share share) {
...
//	public ModelAndView sinchengModify(@PathVariable("num") int num) {
//		ModelAndView mav = new ModelAndView("share/sharelist");
//		try {
//			System.out.println("1");
//			System.out.println(num);
//			shareserv.modifyShareInfo(num);
//		}catch (Exception e) {
//			e.printStackTrace();
//		}
//		
